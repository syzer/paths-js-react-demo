        ...
        render: function () {
            ...
            return (
                <div>
                    ...
                    <div ref="svg">
                        <svg width={500} height={375} onMouseDown={ this.dragStart } onMouseMove={ this.drag }
                            ...
                            <g transform="translate(50, 50)">
                                ...
                                <line x1={ xscale(dateMin) } y1={ yscale(min) + 10 } x2={ xscale(dateMin) }
                                      y2={ yscale(max) - 10 } stroke="#333333"/>
                                <line y1={ yscale(0) } x1={ xscale(dateMin) - 10 } y2={ yscale(0) }
                                      x2={ xscale(dateMax) + 10 } stroke="#333333"/>
                                { points }
                            </g>
                            { this.rectangle() }
                        </svg>
